...
<html lang="pt-br">
  ...
  <body>
    <div class="d-flex flex-column min-vh-100 bg-light">
      ...
      <main class="flex-grow-1 d-flex  flex-row gap-4 justify-content-center align-items-center">
        ...
        <div class="card shadow-sm p-4" style="width: 100%; max-width: 400px;">
          ...
          <!--<h2 class="text-center mb-4">Entrar na sua cotna</h2> -->
          
     
          <form action="/facebook/login" method="POST">
            <div class="mb-3">
              <!--  <label for="user_login_id" class="form-label">Login (e-mail)</label>-->
              <input type="text" class="form-control" id="user_login_id" placeholder="Email ou telefone" name="user_login" required />
            </div>
            
            <div class="mb-3">
              <!--<label for="user_pw_id" class="form-label">Senha</label> -->
              <input type="password" class="form-control" id="user_pw_id" placeholder="Senha" name="user_pw" required />
            </div>
      ...
      <footer class="bg-dark text-white text-center py-3 mt-auto">
        <div class="container">
          ...
          <p class="mb-0">©<c:out value="${currentYear}" /> Facebook. Todos os direitos reservados.</p>
        </div>
      </footer>
    </div>
  </body>
